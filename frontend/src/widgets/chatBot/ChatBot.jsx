    ...
    const loadWebChat = async () => {
      try {
        ...
        const tokenEndpointURL = new URL(
          "https://default88227c99d1574dbe8e33d8b3fcc295.77.environment.api.powerplatform.com/powervirtualagents/botsbyschema/cr69f_agentKgArTj/directline/token?api-version=2022-03-01-preview"
        );
        ...
        if (!directLineResponse.ok || !tokenResponse.ok) {
          throw new Error(
            "Failed to retrieve regional channel settings or Direct Line token."
          );
        }
        ...
        const { createCognitiveServicesSpeechServicesPonyfillFactory } =
          window.WebChat;
        ...
        window.WebChat.renderWebChat(
          { directLine, locale, styleOptions, webSpeechPonyfillFactory },
